...
class DRSformer2_SEG(nn.Module):
    ...
    def forward(self, inp_img):
        ...
        # seg_mask3 = self.seg_out3(inp_dec_level3)
        # out_dec_level3 = self.decoder_level3(inp_dec_level3 * seg_mask3)

        inp_dec_level2 = self.up3_2(out_dec_level3)
        inp_dec_level2 = torch.cat([inp_dec_level2, out_enc_level2], 1)
        inp_dec_level2 = self.reduce_chan_level2(inp_dec_level2)
        out_dec_level2 = self.decoder_level2(inp_dec_level2)
        # seg_mask2 = self.seg_out2(inp_dec_level2)
        # out_dec_level2 = self.decoder_level2(inp_dec_level2 * seg_mask2)
