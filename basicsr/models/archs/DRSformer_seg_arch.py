...
class DRSformer_SEG(nn.Module):
    def __init__(self,
        ...
        super(DRSformer_SEG, self).__init__()
        ...
        self.seg_out = nn.Conv2d(int(dim * 2 ** 1), out_channels=1, kernel_size=3, stride=1, padding=1, bias=bias) # generate a seg-mask
    ...
    def forward(self, inp_img):
        ...
        seg_mask = self.seg_out(out_dec_level1)

        out_dec_level1 = self.output(out_dec_level1) + inp_img

        return out_dec_level1, seg_mask
